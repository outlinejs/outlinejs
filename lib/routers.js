...
var RouteUtils = exports.RouteUtils = function () {
  ...
  _createClass(RouteUtils, null, [{
    ...
    value: function _listenServer() {
      ...
      var proxyServer = _env2.default.get('NODEJS_IP') || '0.0.0.0';
      var proxyPort = parseInt(_env2.default.get('NODEJS_PORT')) || 1337;
        ...
        if (urlPattern instanceof IncludeDefinition) {
          ...
          try {
            var _loop = function _loop() {
              var urlDefinition = _step3.value;
              ...
              try {
                ...
                try {
                  for (var _iterator4 = i18nUrlSegments[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                    var i18nUrlSegment = _step4.value;
            ...
            for (var _iterator3 = urlPattern[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
              _loop();
            }
          } catch (err) {
  ...
  _createClass(BaseRouter, [{
    ...
    value: function routeTo(urlDef, req, res) {
      ...
      if (Controller.loginRequired && !req.user) {
        try {
          var loginUrl = RouteUtils.reverse(_contexts.settings.LOGIN_STATE, null, req);
        } catch (ex) {
