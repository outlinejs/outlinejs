...
var RouteUtils = exports.RouteUtils = function () {
  ...
  _createClass(RouteUtils, null, [{
    ...
    value: function parseUrl(path) {
      ...
      var globalContext = new _contexts.GlobalContext();
      ...
      try {
        var _loop = function _loop() {
          ...
          var descriptor = Reflect.getOwnPropertyDescriptor(globalContextProto, key);
          //props
        ...
        for (var _iterator = Reflect.ownKeys(globalContextProto)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          _loop();
        }
    ...
    value: function query() {
      ...
      if (href) {
        ...
        try {
          for (var _iterator2 = href.split('&')[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
var BaseRouter = exports.BaseRouter = function () {
  function BaseRouter() {
    ...
    try {
      ...
      for (var _iterator3 = Object.keys(this.urlPatterns)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
        var rUrl;
