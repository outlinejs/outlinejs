  ...
  _createClass(BaseController, [{
    ...
    value: function render() {
      ...
      if (_contexts.runtime.isClient) {
        this._viewInstance = _reactDom2.default.render(_react2.default.createElement(View, _extends({}, context, { delegate: this, __request: this.request })), _contexts.runtime.renderContainerObject);
      } else {
        try {
          ...
          var html = _contexts.runtime.renderContainerObject.replace(_contexts.runtime.serverRenderContainerPattern, function (match, pre, inside, post) {
            return pre + _server2.default.renderToString(_react2.default.createElement(View, _extends({}, context, { delegate: _this, __request: _this.request }))) + post;
          });
