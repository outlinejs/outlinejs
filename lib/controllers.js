  ...
  _createClass(BaseController, [{
    ...
    value: function render() {
      ...
      if (_contexts.runtime.isClient) {
        if (_contexts.runtime.currentClientResponse === this.response) {
          this._viewInstance = _reactDom2.default.render(_react2.default.createElement(View, _extends({}, context, { delegate: this, __request: this.request, __response: this.response, __self: this
        ...
        try {
          ...
          var html = _contexts.runtime.renderContainerObject.replace(_contexts.runtime.serverRenderContainerPattern, function (match, pre, inside, post) {
            return pre + _server2.default.renderToString(_react2.default.createElement(View, _extends({}, context, { delegate: _this, __request: _this.request, __response: _this.response, __self: _this
            }))) + post;
          });
...
var BaseLayoutController = exports.BaseLayoutController = function (_BaseController) {
  ...
  function BaseLayoutController() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(BaseLayoutController).apply(this, arguments));
  }
